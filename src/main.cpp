...
// // AWS MQTT Handler instance
// AwsMqttHandler awsMqtt;
...
//         // Give WiFi and DNS services time to fully initialize
//         delay(3000);
...
//         bool connected = awsMqtt.connect();
...
//         {   
//             if (DEBUG_MODE) {
//             Serial.println("Pushing variables to AWS");            
//             }
//             awsMqtt.publishPodStatus(1);
//             awsMqtt.publishLedStatus(0);
//             awsMqtt.publishLedColor("FF0000");
//             awsMqtt.publishLedBrightness(50);
//         }
//     } else if (DEBUG_MODE) {
...
//         // Check MQTT connection status once
//         bool mqttReady = awsMqtt.isConnected();
        
//         // Handle MQTT push here
